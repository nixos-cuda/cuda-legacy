  ...
  outputs =
    ...
    let
      ...
      inputs =
        let
          defaults = {
            nixpkgs = getFlake "github:NixOS/nixpkgs/80b5bad03497d33646dcb93c7e9293d82a784991";
            flake-parts = getFlake "github:hercules-ci/flake-parts/26d05891e14c88eb4a5d5bee659c0db5afb609d8";
          };
